...
$config['session_timeout'] = intval($config['session_timeout']);
$timeout_js = "";
...
<head>
	<meta charset="utf-8">
	<title>Cicada 3301 - {$lang['skin_title']}</title>
...
<div id="loading-layer" class="shadow-depth3"><i class="fa fa-spinner fa-spin"></i></div>
	<div class="navbar navbar-inverse bg-primary-700">
		<div class="navbar-header">
			<a class="navbar-brand" href="?mod=main">Cicada 3301</a>
...
$skin_footer = <<<HTML
					<div class="footer text-muted text-size-small">
						Cicada 3301&reg;  Copyright 2004-{$year} &copy; <a href="https://github.com/cicadadenis/" target="_blank">Cicada_3301 Media Group</a> All rights reserved.
					</div>
				</div>
			</div>
		</div>
...
<!--MAIN area-->
	...
	<div class="text-muted text-size-small text-center">Cicada 3301&reg;  Copyright 2004-{$year}<br>&copy; <a href="https://github.com/cicadadenis/" target="_blank">Cicada Media Group</a> All rights reserved.</div>
