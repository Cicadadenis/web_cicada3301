...
HTML;
		...
		if ( isset($allow_subscribe) AND $allow_subscribe ) $code .= "<br /><label class=\"comments_subscribe\"><input type=\"checkbox\" name=\"allow_subscribe\" id=\"allow_subscribe\" value=\"1\" />" . $lang['c_subscribe'] . "</label><br />";
