...
jQuery(function($){
	var uploader = new qq.FileUploader({
		...
		onSubmit: function(id, fileName) {
					$('<div id="uploadfile-'+id+'" class="file-box" style="max-width:400px!important;"><span class="qq-upload-file">{$lang['media_upload_st6']}&nbsp;'+fileName+'</span><span class="qq-status"><span class="qq-upload-spinner"></span><span class="qq-upload-size"></span></span><div class="progress "><div class="progress-bar progress-blue" style="width: 0%"><span>0%</span></div></div></div>').appendTo('#cat-uploader');
       },
