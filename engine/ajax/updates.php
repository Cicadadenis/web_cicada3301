...
$data = @file_get_contents("https://github.com/cicadadenis/extras/updates.php?version_id=".$_REQUEST['versionid']."&build=".$_REQUEST['build']."&key=".$config['key']."&lang=".$lang['wysiwyg_language']);
