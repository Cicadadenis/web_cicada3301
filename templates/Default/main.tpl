						...
						<div class="midside">
							<div id="header_menu">
								...
								<a class="logotype" href="/">
									<span class="logo_icon"><img src="/templates/Default/images/favicon.ico" alt=""></span>
									<span class="logo_title">Cicada 3301</span>
								</a>
								<!-- / Логотип -->
								<!-- Основное Меню -->
								<nav id="top_menu">
			...
			<div class="page_form__body">
				<div class="page_form__logo">
					...
					<a href="/">
						...
						<span class="title_hide">Cicada 3301</span>
					</a>
					<!-- / Логотип -->
				</div>
				{info}
